...
namespace lvl.Repositories
{
    ...
    internal sealed class SQLitePersistentSessionProvider : SessionProvider
    {
        ...
        public SQLitePersistentSessionProvider(ISessionFactory sessionFactory, IInterceptor interceptor, DatabaseCreator databaseCreator, Configuration configuration) : base(sessionFactory, interceptor)
        {
