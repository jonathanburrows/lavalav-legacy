...
{
    /// <summary>Represents a set of tokens which must be reduced by the parser.</summary>
    internal class TokenStack
    {
        private Queue<Token> Tokens { get; }

        /// <summary>Allows the parser to peek at the next token.</summary>
        ...
        /// <summary>Signifies the parser has consumed the first token in the stack.</summary>
        public void Next()
        {
            Tokens.Dequeue();
        }
